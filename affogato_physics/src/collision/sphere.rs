use affogato_core::{groups::vector_spaces::{MetricSpace, NormedVectorSpace, VectorSpace}, num::Zero, sets::Real};
use affogato_math::{geometry::{Circle, HyperSphere, Sphere}, vector::{Vector2, Vector3}};
...
fn hsphere_collision<V: NormedVectorSpace + MetricSpace + PartialEq, S: HyperSphere<V>>(s0: &S, s1: &S) -> Option<HitCollisionInfo<V>> 
    where V::Scalar: Real {
