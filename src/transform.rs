...
use crate::{linear::{Matrix4, SquareMatrix, Vector3, Matrix3}, definitions::{Number, FloatingPoint}, complex::Quaternion};
...
impl<T: FloatingPoint> Transform<T> {
    pub fn new(translation: Vector3<T>, scaling: Vector3<T>, rotation: Quaternion<T>,) {
